...
// Modified 2022 by Johannes Denzel
//licensed under
// GNU GPL v3.0, https://www.gnu.org/licenses/gpl.html

#include "MovingAvg_int16.h"

// initialize - allocate the interval array
void MovingAvg_int16::begin()
{
    m_readings = new int16_t[m_interval];
}

// add a new reading and return the new moving average
int16_t MovingAvg_int16::reading(int16_t newReading)
{
...
int16_t MovingAvg_int16::getAvg()
{
    return (m_sum + m_nbrReadings / 2) / m_nbrReadings;
}
...
int16_t MovingAvg_int16::getAvg(int nPoints)
{
